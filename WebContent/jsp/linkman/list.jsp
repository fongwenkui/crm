										...
										<FORM id="pageForm" name="linkManForm"
											...
											<TBODY>
												<TR>
													...
													<td colspan="3"><input type="text" id="cust_name"
														name="cust_name" style="WIDTH: 80px" value='${cust_name }' />
													...
													<TD><INPUT class=button id=sButton2 type=button
														onclick="submitForm()" value=" 筛选 " name=sButton2></TD>
												</TR>
											</TBODY>
										</FORM>
									</TABLE>
										...
										<TBODY>
											...
											<s:iterator value="#pageBean.list" var="lkm">
												<TR
													...
													<TD><s:property value="#lkm.lkm_name" /></TD>
													<TD><s:property value="#lkm.lkm_gender" /></TD>
													<TD><s:property value="#lkm.lkm_mobile" /></TD>
													<TD><s:property value="#lkm.lkm_phone" /></TD>

													<TD><a
														href="${pageContext.request.contextPath }/LinkManAction_toEdit?lkm_id=<s:property value="#lkm.lkm_id" />">修改</a>
														&nbsp;&nbsp; <a href="javaScript:void(0)"
														onclick='if(confirm("您是否要删除?"))window.location.href="${pageContext.request.contextPath }/LinkManAction_delete?lkm_id=<s:property value="#lkm.lkm_id" />"'>删除</a>
													</TD>
												</TR>
											</s:iterator>
										</TBODY>
